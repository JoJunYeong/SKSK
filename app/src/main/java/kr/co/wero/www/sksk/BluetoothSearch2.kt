...
class BluetoothSearch2 : AppCompatActivity() {
    ...
    lateinit val mBTAdapter: BluetoothAdapter? = null
    ...
    private class SearchDevices :
        ...
        protected override fun onPostExecute(listDevices: List<BluetoothDevice?>) {
            ...
            if (listDevices.size > 0) {
              ...
              Toast.make`Text(this, "No paired devices found, please pair your serial BT device and try again", Toast.LENGTH_SHORT).show()
            }
        }
    }
